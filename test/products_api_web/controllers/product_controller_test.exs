defmodule ProductsApiWeb.ProductControllerTest do
  ...
  @create_attrs %{inventory_count: 42, price: "some price", title: "some title"}
  ...
  def fixture(:product) do
    {:ok, product} = ProductList.create_product(@create_attrs)
    product
  end
  ...
  describe "update product" do
    ...
    test "redirects when data is valid", %{conn: conn, product: product} do
      ...
      assert html_response(conn, 200) =~ "some updated price"
    end
